const menuItems = {
  Coffee: [
    ...
    {
      name: 'Aerocano',
      description: 'Aeropress-brewed coffee combined with water, offering a cleaner, richer taste.',
      priceIced: 'MYR 13.00',
    ...
    {
      name: 'Matcha Latte',
      description: 'Vibrant matcha mixed with steamed milk for a creamy and energizing drink.',
      priceHot: 'MYR 12.00',
      priceIced: 'MYR 13.00',
  ...
  Tea: [
    {
      ...
      description: 'A robust and traditional black tea, perfect for a strong start to your day.',
      priceHot: 'MYR 10.00',
      priceIced: 'MYR 10.00',
    },
    {
    ...
    },
    {
      ...
      description: 'A vibrant and refreshing tea infused with the flavors of seasonal fruits.',
      priceHot: 'MYR 10.00',
      priceIced: 'MYR 10.00',
    },
    {
      name: 'Chamomile Tea',
      description: 'A soothing herbal tea known for its calming and relaxing properties.',
      priceHot: 'MYR 10.00',
      priceIced: 'MYR 10.00',
    },
    {
      name: 'Earl Grey Tea',
      description: 'A bold black tea infused with the distinctive essence of bergamot citrus.',
      priceHot: 'MYR 10.00',
      priceIced: 'MYR 10.00',
    },
    {
      name: 'Green Tea',
      description: 'A pure and refreshing tea, rich in antioxidants with a clean, mild flavor.',
      priceHot: 'MYR 10.00',
      priceIced: 'MYR 10.00',
    },
    {
    ...
    {
      name: 'Milk Tea',
      description: 'A creamy and indulgent blend of tea and milk for a smooth, rich experience.',
      priceHot: 'MYR 10.00',
      priceIced: 'MYR 10.00',
    },
  ],
  ...
  Chocolate: [
    ...
    },
    {
      ...
      description: 'A smooth and velvety cocoa infused with the nutty flavor of roasted hazelnuts.',
      priceHot: 'MYR 15.00',
      priceIced: 'MYR 15.00',
      image: '/images/chocolate.jpg',
    },
